...
Move this file to wp-content/object-cache.php
*/
...
class WP_Object_Cache {
	...
	function close() {
		// Not implemented in MemcacheSASL
	}
	...
	function WP_Object_Cache() {
		...
		if ( isset($memcachier_servers) )
			...
			$buckets = array(
				'default' => array(
					getenv('OPENSHIFT_MEMCACHED_HOST').':'.getenv('OPENSHIFT_MEMCACHED_PORT'),
				)
			);
		...
		foreach ( $buckets as $bucket => $servers) {
			...
			foreach ( $servers as $server  ) {
				...
				$this->mc[$bucket]->setSaslAuthData(getenv("OPENSHIFT_MEMCACHED_USERNAME"), getenv("OPENSHIFT_MEMCACHED_PASSWORD"));
